...
public class AudioOutputManager implements AudioTrack.OnPlaybackPositionUpdateListener {
	...
	private final String LogTag = "AudioOutput";
		...
		while (pos < pcm.length) {			
            ...
            switch (written) {
                case AudioTrack.ERROR_BAD_VALUE:
                    ...
                    // TODO: This occurs when the user lifts their finger from the speaker icon.
                    // TODO: I think this is due to the audio buffer being flushed whilst it is still being written to
                    // TODO: thus invalidating pos. I guess it needs some locks.
                    Log.e(LogTag+".buffer", "ERROR_BAD_VALUE");
                    return;

                case AudioTrack.ERROR_INVALID_OPERATION:
                    // Object was not properly initialised
                    Log.e(LogTag+".buffer", "ERROR_INVALID_OPERATION");
                    return;
